                ...
                <?php
                                       ...
                                       if ($result->num_rows > 0) {
                                           ...
                                           while ($row = $result->fetch_assoc()) {
                                            ...
                                            $sql1 = "SELECT * from dette_aep where idBenefique='$idBenefique' ";
                   ...
                   <a href="#" class="btn btn-sm " disabled style="background-color:'.$color.'">'.$active.' </a>
...
<div class="card bg-secondary border-0 ">
  <div class="card-header bg-transparent pb-2">
      <h3 class=" text-center mt-2">حذف منتفع ؟</h3><br>
      <div class="text-center mb-4">هل أنت متأكد أنك تريد حذف المنتفع ؟ <br><br>  صاحب ب.ت.و. : '.$row['CIN'].' <br> صاحب العداد :  '.$row['numCompteur'].'</div>
        
          <!--<div class="btn-wrapper text-center">
              <a href="controller/controller.php?idBenefiqueAEP='.$row['idBenefique'].'" name="deleteBenefiqueAEP" class="btn btn-neutral btn-icon">
...
<a href="controller/controller.php?idBenefiqueAEP='.$row['idBenefique'].'" name="deleteBenefiqueAEP" type="submit" onclick=" return checkInputsConsommation()"  class="btn btn-primary" >حذف</a>
</div>
          </div>
