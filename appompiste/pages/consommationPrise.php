      ...
      <div class="card shadow">
         <div class="card-header bg-secondary border-0">
            <div class="row align-items-center">
               <div class="col-8">
                  <h3 class="mb-0">استهلاك المأخذ </h3>
               </div>
               <div class="col-4 text-right">
                  <a href="#!" data-toggle="modal" data-target="#modal-form" class="btn btn-sm btn-primary">إضافة</a>
               </div>
            </div>
            </div>
            <div class="row">
            <form  action="controller/controller.php" method="post">
              <div class="col-md-6">
                           ...
                           <div class="modal-body p-0">
                              <div class="card bg-secondary border-0 mb-0">
                                 <div class="card-header bg-transparent pb-1">
                                    <h3 class=" text-center mt-2 mb-3">رفع إستهلاك المأخذ</h3>
                                    <br>
                                    <div class="row">
                                       <div class="col-lg-12">
                                          <div class="form-group">
                                             <label class="form-control-label" for="input-country">رقم المأخذ</label>
                                             <input type="number" id="numPrise" list="numeroCompteur" class="form-control form-control-alternative" placeholder="رقم المأخذ" name="numPrise" >
               ...
               <input type="submit" onclick=" return checkInputsConsommationPrise()" name="ajoutConsommationPrise" class="btn btn-primary" value="تسجيل">
               </div>
               </div>
               </div>
               </div>
 ...
 <?php echo $_SESSION['message'];  unset($_SESSION['message']); ?>
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            ...
            <table id="listeBenefique" class=" table  align-items-center table-striped table-flush">
               ...
               <tbody>
                <?php
                 $sql = "SELECT idConsommation FROM consommation_prise_pi where idGess='$idGess' ORDER BY date DESC LIMIT 1";
                 $result = $conn->query($sql);
                 $row = $result->fetch_assoc();
                 $idLatest=$row["idConsommation"];


                 $sql = "SELECT * FROM consommation_prise_pi where idGess='$idGess' order by date desc"; 
                 $result = $conn->query($sql);
                                       ...
                                       if ($result->num_rows > 0) {
                                           ...
                                           while ($row = $result->fetch_assoc()) {
                                            ...
                                            $sql1 = "SELECT * FROM prise_pi where numPrise='$numPrise'";
...
<form  action="controller/controller.php" method="post">
              <div class="col-md-6">
                                 ...
                                 <div class="card-header bg-transparent pb-1">
                                    ...
                                    <div class="col-lg-12">
                                          <div class="form-group">
                                             ...
                                             <input type="number" id="idConsommation" class="form-control form-control-alternative" placeholder="رمز العملية" name="idConsommation" readonly value="<?php echo $row['idConsommation'] ?>">
                                    ...
                                    <div class="col-lg-12">
                                          <div class="form-group">
                                             <label class="form-control-label" for="input-country">رقم  المأخذ</label>
                                             <input type="number" id="numPrise" class="form-control form-control-alternative" placeholder="رقم  المأخذ" name="numPrise" readonly value="<?php echo $row['numPrise'] ?>">
               ...
               <div class="modal-footer flex-row-reverse">
               <button type="button" class="btn btn-secondary" data-dismiss="modal">إلغاء</button>
               <input type="submit" name="modifierConsommationPrise" class="btn btn-primary" value="تسجيل">
               </div>
               </div>
               </div>
               </div>
