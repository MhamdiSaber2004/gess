                    ...
                    <td class="text-center">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="../directeur/uploads/'.$row['chemain'].'">تحميل </a>
                          <!--<a class="dropdown-item" data-toggle="modal" data-target="#supprimerDocument'.$row['idD'].'" href="index.php?page=listePompiste&action=supprimer&id=">حذف</a>-->
                        </div>
                      </div>
                    </td>
                    </tr>
