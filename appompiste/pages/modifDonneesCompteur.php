<?php
if(isset($_GET['idConsommation']) && ! empty ( $_GET['idConsommation'] ))
{
    $idConsommation=$_GET['idConsommation'];
    $sql = "SELECT * FROM consommation where idConsommation=$idConsommation";
      ...
      <div class="card bg-white shadow">
        <div class="card-header bg-secondary border-0">
          <div class="row align-items-center">
            <div class="col-8">
              <h3 class="mb-0">تحيين معطيات الاستهلاك  </h3>
            </div>
            <div class="col-4 text-right">
              <a href="index.php?page=donneesCompteurs" class="btn btn-sm btn-primary">رجوع</a>
            </div>
          </div>
        </div>
        <div class="card-body">
          <form onsubmit ="return checkInputsProbleme()" action="controller/controller.php" method="post">
            ...
            <div class="pl-lg-4">
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input id="idConsommation" class="form-control form-control-alternative" placeholder="رمز العطب " type="text" name="idConsommation" readonly>
                  </div>
                </div>
                <div class="col-lg-12">
                  <div class="form-group">
