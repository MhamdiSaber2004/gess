 ...
 <?php echo $_SESSION['message'];  unset($_SESSION['message']); ?>
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            ...
            <div class="pl-lg-4">
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input id="id" class="form-control form-control-alternative" placeholder="رمز الحارس (تلقائي)" type="text" name="idPompiste" readonly value="<?php echo $row['idPompiste']; ?>">
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group">
            ...
            <div class="text-center">
              <button type="submit" onclick ="return checkInputsParametrePompiste()" name="parametreCompte" class="btn btn-primary my-4">تحيين</button>
            </div>
          </form>
        </div>
      </div>
