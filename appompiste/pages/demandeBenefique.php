 ...
 <?php echo $_SESSION['message'];  unset($_SESSION['message']); ?>
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            ...
            <table id="listeBenefique" class=" table  align-items-center table-striped table-flush">
                ...
                <tbody>
                <?php
                                       $sql = "SELECT * FROM demandes_benefique where idGess='$idGess' and active='1'";
                    ...
                    <td class="text-center">
                        ...
                        <a  href="controller/controller.php?accepteDemandeBenefique='.$row['idDemandeBenefique'].'" class="btn btn-sm btn-primary">تسجيل </a>
