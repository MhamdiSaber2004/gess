 ...
 <?php echo $_SESSION['message'];  unset($_SESSION['message']); ?>
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            ...
            <table id="listeBenefique" class=" table  align-items-center table-striped table-flush">
                ...
                <tbody>
                <?php
                                       $sql = "SELECT * FROM benefique_pi where idGess='$idGess' ";
...
<div class="card bg-secondary border-0 ">
  <div class="card-header bg-transparent pb-2">
      ...
      <div class="text-center mb-4">هل أنت متأكد أنك تريد حذف المنتفع ؟ <br><br>  صاحب ب.ت.و. : '.$row['CIN'].' <br> صاحب العداد :  '.$row['numCompteur'].'</div>
          ...
          <!--<div class="btn-wrapper text-center">
              <a href="controller/controller.php?idBenefiquePI='.$row['idBenefique'].'" name="deleteBenefiquePI" class="btn btn-neutral btn-icon">
...
<a href="controller/controller.php?idBenefiquePI='.$row['idBenefique'].'" name="deleteBenefiquePI" type="submit" onclick=" return checkInputsConsommation()"  class="btn btn-primary" >حذف</a>
</div>
          </div>
