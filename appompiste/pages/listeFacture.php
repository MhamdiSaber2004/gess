            ...
            <div class="card-header bg-secondary border-0">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                  <a href="index.php?page=ajoutProbleme" class="btn btn-sm btn-primary">إستخراج فاتورة</a>
                </div>
              </div>
            </div>
                    ...
                    <td class="text-center">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="index.php?page=printProbleme&idProbleme='.$row['idProbleme'].'">تفاصيل و طباعة</a>
