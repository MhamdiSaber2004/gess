      ...
      <div class="card shadow">
         <div class="card-header bg-secondary border-0">
            ...
            <div class="col-md-6">
                      ...
                      <div class="modal-content">
                         <div class="modal-body p-0">
                            ...
                            <?php if(!isset($_POST['CIN']) && !isset($_POST['idBenefique'])) { ?>
                              <form  action="index.php?page=payementAEP" method="post">
                                           ...
                                           <datalist id="numeroCompteur">
                                              <?php
                                                 $idPompiste=$_SESSION['idPompiste'];
                                                  ...
                                                  $sql = "SELECT * FROM benefique_aep where idGess='$idGess' ";
                               ...
                               <div class="card-header bg-transparent pb-1">
                                  ...
                                  <div class="col-lg-12">
                                        ...
                                        <?php 
                                        $CIN=$_POST['CIN'];
                                        $sql = "SELECT * FROM benefique_aep where CIN='$CIN'";
                                        $result = $conn->query($sql);
             ...
             <div class="modal-footer flex-row-reverse">
             <a href="index.php?page=payementAEP" type="button" class="btn btn-primary">رجوع</a>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input name="dateN" type="date" id="CIN" class="form-control form-control-alternative" readonly placeholder="رقم بطاقة التعريف" value="<?php echo $row['dateN'] ?>">
                            ...
                            <div class="modal-footer flex-row-reverse">
                            <a href="index.php?page=payementAEP" type="button" class="btn btn-secondary">رجوع</a>
             ...
             <div class="modal-footer flex-row-reverse">
             <a href="index.php?page=payementAEP" type="button" class="btn btn-primary">إلغاء</a>
             <button type="submit" name="payementArchiveAEP" class="btn btn-primary">تأكيد</button>
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            ...
            <table id="listeBenefique" class=" table  align-items-center table-striped table-flush">
               ...
               <tbody>
                ...
                $sql = "SELECT * FROM archive_payement_aep where idGess='$idGess' order by date desc";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {

                  while ($archive_payement_aep = $result->fetch_assoc()) {

                     $idBenefique=$archive_payement_aep['idBenefique'];

                     $sql = "SELECT * FROM benefique_aep inner join dette_aep where benefique_aep.idBenefique=".$archive_payement_aep['idBenefique'];
                ...
                $benefiqueAndDette = $result1->fetch_assoc();
                                               ...
                                               <tr>
                                               <th scope="row">'
                                               . $archive_payement_aep["idPayement"] .'
                                               </th>
                                               <th scope="row">'
                    ...
                    <td>'
                    . $archive_payement_aep['montantPaye'] .' دت 
                    </td>
                    <td>'
                    .$archive_payement_aep['dette'].' دت 
                    </td>
                    <td>'
                    . $archive_payement_aep['dette'] - $archive_payement_aep['montantPaye'] .' دت 
                    </td>
                    <td>'
                    . substr($archive_payement_aep['date'], 0,10).'
                    </td>
                    
                    <td class="text-center">
                    <a href="?page=recuPayementAEP&idPayement='.$archive_payement_aep['idPayement'].'" class="btn btn-sm btn-primary">طباعة</a>
                    </td>
                    </tr>
