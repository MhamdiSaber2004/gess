...
<h3 style="text-align: right;font-size:22px">مرحبا</h3>
<h5 style="text-align: right;font-size:16px"> مجمع التنمية في قطاع الفلاحة و الصيد البحري للري </h5>
<div class="title1">  
  <span class="text-with-border">الميزانية السنوية لسنة 
    <?php
        $montNow = date('m');
...
<table>
    ...
    <tr>
      <td  colspan="1"><input type="number" step="any"   name="connexion_dediee" id="connexion_dediee" placeholder="عبر الربط الخاص	" dir="rtl"  value="" onkeyup="calcul()"  ></td>
      <td  colspan="1">	م3</td>
      <td  colspan="3">عبر الربط الخاص	</td>
      <td  colspan="2" rowspan="2">   الكمية المزمع توزيعها</td>
      <td  colspan="1" style="width:8px">(6)</td>
    ...
    <tr>
      <td  colspan="1"><input type="number" step="any" name="points_deau_publics" placeholder="عبر الحنفيات العمومية" id="points_deau_publics"  dir="rtl"  value="" onkeyup="calcul()"  ></td>
      <td  colspan="1">	م3</td>
      <td  colspan="3"> عبر الحنفيات العمومية/ مزود الصهاريج </td>
      <td  colspan="1" style="width:8px">(7)</td>
    </tr>
    ...
    <tr>
      <td colspan="1" ><input type="number" step="any" onkeyup="calcul()" dir="rtl" name="nombre_bi_prevus" id="nombre_bi_prevus" placeholder="  BI عدد"  ></td>
      <td colspan="2" >  المزمع انجازها BI    عدد </td>
      <td colspan="1" >(33)</td>
      <td colspan="1" ><input type="number" step="any" onkeyup="calcul()" dir="rtl" name="prix_litre_javal" id="prix_litre_javal" placeholder="سعر لتر جافال"  ></td>
      <td colspan="2" >  	سعر لتر جافال    </td>
      <td colspan="1"  style="width:8px">(23)</td>
    </tr>
    <tr>
      <td colspan="1" ><input type="number" step="any" onkeyup="calcul()" dir="rtl" name="bi_realisation" id="bi_realisation" placeholder="BI معلوم إنجاز "  ></td>
      <td colspan="2" >BI معلوم إنجاز </td>
      <td colspan="1" >(34)</td>
    ...
    <tr>
      <td colspan="1" ><input type="number" step="any" onkeyup="calcul()" dir="rtl" name="couverture_deficit_maintenance" id="couverture_deficit_maintenance" placeholder=" تغطية عجز الصيانة"  ></td>
      <td colspan="2" >تغطية عجز الصيانة</td>
      <td colspan="1" >(36)</td>
    ...
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input type="number" step="any" onkeyup="calcul()" dir="rtl" name="depenses_analyse_eau" id="depenses_analyse_eau" placeholder=" مصاريف تحليل الماء" onkeyup="calcul()" ></td>
      <td colspan="2" >	مصاريف تحليل الماء</td>
      <td colspan="1"  style="width:8px">(45)</td>
    </tr> 
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input disabled type="number" step="any" onkeyup="calcul()" dir="rtl" name="depenses_jafal" id="depenses_jafal"  onkeyup="calcul()" ></td></td>
      <td colspan="2" > 	مصاريف الجافال  = ((3)/(40))*23</td>
      <td colspan="1"  style="width:8px">(46)</td>
    </tr> 
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input  type="number" step="any" dir="rtl" name="huiles_et_filtres" placeholder="زيوت و مصافي" id="huiles_et_filtres" onkeyup="calcul()" ></td>
      <td colspan="2" >زيوت و مصافي</td>
      <td colspan="1"  style="width:8px">(47)</td>
    </tr> 
    <tr>
    ...
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input disabled type="number" step="any" dir="rtl" name="cout_realisation_connexion_speciale" id="cout_realisation_connexion_speciale" onkeyup="calcul()"></td>
      <td colspan="2" >تكاليف انجاز الربط الخاص = (33) * (34)</td>
      <td colspan="3"rowspan="2" >  			مصاريف الإستثمار والتجهيز  </td>
      <td colspan="1" rowspan="2" style="width:8px">(53)</td>
    </tr> 
    ...
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input disabled type="number" step="any" dir="rtl" name="revenus_realises_sur_realisation_raccordement_specifique" id="revenus_realises_sur_realisation_raccordement_specifique" onkeyup="calcul()" ></td>
      <td colspan="5" >المداخيل الموظفة على انجاز الربط الخاص = (33) * (34)</td>
      <td colspan="1"  style="width:8px">(60)</td>
    </tr> 
    <tr>
    ...
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input disabled type="number" step="any" dir="rtl" name="prix_m3_sans_garde_administrateur" id="prix_m3_sans_garde_administrateur" onkeyup="calcul()" ></td>
      <td colspan="3" >	سعر م3 من الماء بدون حارس متصرف = ((58) - (أجرة الحارس المتصرف)) / (5)	</td>
      <td colspan="1"  style="width:8px">(65)</td>
    </tr> 
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input disabled type="number" step="any" dir="rtl" name="tarif_m3_eau" id="tarif_m3_eau1" onkeyup="calcul()" ></td>
      <td colspan="3" >	سعر م3  = (58) / (5)</td>
      <td colspan="2" rowspan="2">	على مستوى الربط الخاص</td>
      <td colspan="1"  style="width:8px">(66)</td>
    </tr> 
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input disabled type="number" step="any" dir="rtl" name="information_mensuelle_global" id="information_mensuelle_global" onkeyup="calcul()" ></td>
      <td colspan="3" >		المعلوم الشهري القار = ( 35 )</td>
      <td colspan="1"  style="width:8px">(67)</td>
    </tr> 
