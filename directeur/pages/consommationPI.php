                                          ...
                                          <div class="form-group">
                                             ...
                                             <datalist id="numeroCompteur">
                                                <?php
                                                    ...
                                                    $sql = "SELECT numCompteur FROM benefique_pi where idGess='$idGess'  and active=1";
 ...
 <?php echo $_SESSION['message'];  unset($_SESSION['message']); ?>
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            ...
            <table id="listeBenefique" class=" table  align-items-center table-striped table-flush">
               ...
               <tbody>
                <?php
                 $sql = "SELECT idConsommation FROM consommation_pi ORDER BY date DESC LIMIT 1";
                 $result = $conn->query($sql);
                 $row = $result->fetch_assoc();
                 $idLatest=$row["idConsommation"];


                                       $sql = "SELECT * FROM consommation_pi where idGess='$idGess' order by consommation_pi.date desc";
                                       $result = $conn->query($sql);
                                       ...
                                       if ($result->num_rows > 0) {
                                           ...
                                           while ($row = $result->fetch_assoc()) {
                                            ...
                                            $sql1 = "SELECT nom FROM benefique_pi where numCompteur='$numCompteur'";
