...
if($typeR==1){
    $urlfile='<a href="https://gda2.ness.com.tn/assets/fichier/direct/اعلان-عن-الجلسة-العامة.pdf" target="_blank" class="btn btn-sm btn-primary"> الاعلان عن جلسة العامة  </a>';
}else if($typeR==2){
    ...
    $urlfile='<a href="https://gda2.ness.com.tn/assets/fichier/direct/التقرير-الأدبي.pdf" target="_blank" class="btn btn-sm btn-primary"> التقرير الأدبي</a>';
}else if($typeR==4){
    $urlfile='<a href="https://gda2.ness.com.tn/assets/fichier/direct/التقرير-المالي.pdf" target="_blank" class="btn btn-sm btn-primary"> التقرير المالي  </a>';
}else if($typeR==5){
