          ...
          <div class="card shadow">
            ...
            <div class="card-header bg-secondary border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">قائمة الكشوفات الوضع المالي للمجمع  </h3>
                </div>
...
?>
            ...
            <div class="table-responsive col-12">
              ...
              <table id="listeBenefique" class=" table  align-items-center table-striped table-flush">
                ...
                <tbody>
                <?php
                  $sql = "SELECT * FROM financesituation where idGess='$idGess' and `activ`='1'";
                  $result = $conn->query($sql);
                            ...
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        <a class="dropdown-item" href="uploads/'.$row['doc'].'" download="financeSituation le '.$row['dateDebut'].' à '.$row['dateFin'].'" >تفاصيل و طباعة</a>
                                        <a class="dropdown-item" href="controller/controller.php?idFinanceSituationdec='.$row["idFinanceSituation"].'">حذف</a>
                                    </div>
                                </div>
                            </td>
                        </tr>';
