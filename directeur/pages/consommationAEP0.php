         ...
         <div class="card-header bg-secondary border-0">
            ...
            <form  action="controller/controller.php" method="post">
              <div class="col-md-6">
               ...
               <input type="submit" onclick=" return checkInputsConsommation()" name="ajoutConsommationAEP" class="btn btn-primary" value="تسجيل" require>
               </div>
               </div>
               </div>
               </div>
...
<form  action="controller/controller.php" method="post">
              <div class="col-md-6">
               ...
               <div class="modal-footer flex-row-reverse">
               <button type="button" class="btn btn-secondary" data-dismiss="modal">إلغاء</button>
               <input type="submit" name="modifierConsommationAEP" class="btn btn-primary" value="تسجيل" require>
               </div>
               </div>
               </div>
               </div>
