                   ...
                   <option value="متسوغ" <?php if($row['propriete']=="متسوغ") echo "selected" ?>> متسوغ</option>
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input  name="numFamille" type="text" id="numFamille" class="form-control form-control-alternative" placeholder="عدد افراد العائلة " value="<?php echo $row['numFamille'] ?>">
                      </div>
                    </div>
                    <div class="col-lg-12">
                      <div class="form-group">
                        <label class="form-control-label" for="input-last-name">التجمع السكني</label>
                        <input  name="unionFamiliale" type="text" id="numFamille" class="form-control form-control-alternative" placeholder="التجمع السكني" value="<?php echo $row['unionFamiliale'] ?>">
                      </div>
                    </div>
                  </div>
                  <hr class="my-4" />
