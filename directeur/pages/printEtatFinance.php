            ...
            <div class="card-header bg-secondary border-0">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                  <a href="index.php?page=financeSituation" class="btn btn-sm btn-primary">رجوع</a>
                </div>
              </div>
            </div>
            <div class="card-body">
...
<div id="printDiv">
    ...
    <table style="border: 1px solid;width:70%">
      ...
      <tr style="border: 1px solid;">
                ...
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp18"></td>
      </tr>
      <tr style="border: 1px solid;">
                <td  style="border: 1px solid;">الحساب الجاري</td>
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp21"></td>
      </tr>
      <tr style="border: 1px solid;">
                <td  style="border: 1px solid;">الرصيد الجملي في أول السنة</td>
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp24"></td>
      </tr>
    </table>
    <br>
    <table style="border: 1px solid;width:70%">
      ...
      <tr style="border: 1px solid;">
                ...
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp18" id="in5irat"></td>
      </tr>
      <tr style="border: 1px solid;">
                <td  style="border: 1px solid;">الاشتراكات</td>
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp21" id="ichtirak"></td>
      </tr>
      <tr style="border: 1px solid;">
                <td  style="border: 1px solid;">بيع ماء</td>
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp24" id="bay3ma"></td>
      </tr>
      <tr style="border: 1px solid;">
                <td  style="border: 1px solid;">مداخيل أخرى</td>
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp24" id="mada5ilo5ra"></td>
      </tr>
      <tr style="border: 1px solid;">
                <td  style="border: 1px solid;">مداخيل مختلفة</td>
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp24" id="mada5ilm5talifa"></td>
      </tr>
      <tr style="border: 1px solid;">
                <td  style="border: 1px solid;">مجموع المداخيل</td>
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp24" id="totalmada5il"></td>
      </tr>
    </table>
    <br>
    <table style="border: 1px solid;width:70%">
      ...
      <tr style="border: 1px solid;">
                ...
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp18" id="chra2ma"></td>
      </tr>
      <tr style="border: 1px solid;">
                <td  style="border: 1px solid;">مصاريف استغلال أخرى</td>
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp21" id="isti8lelma"></td>
      </tr>
      <tr style="border: 1px solid;">
                <td  style="border: 1px solid;">صيانة وإصلاح</td>
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp24" id="siyana"></td>
      </tr>
      <tr style="border: 1px solid;">
                <td  style="border: 1px solid;">أجور (مدير فني، عمال)</td>
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp24" id="2oujour"></td>
      </tr>
      <tr style="border: 1px solid;">
                <td  style="border: 1px solid;">إدارة وتصرف</td>
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp24" id="idara"></td>
      </tr>
      <tr style="border: 1px solid;">
                <td  style="border: 1px solid;">مصاريف مختلفة</td>
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp24" id="masarifo5ra"></td>
      </tr>
      <tr style="border: 1px solid;">
                <td  style="border: 1px solid;">مصاريف الأنشطة الأخرى</td>
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp24" id="masarifanchta"></td>
      </tr>
      <tr style="border: 1px solid;">
                <td  style="border: 1px solid;">استشار وتجهيز</td>
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp24" id="istichara"></td>
      </tr>
      <tr style="border: 1px solid;">
                <td  style="border: 1px solid;">مجموع المصاريف</td>
                <td  style="border: 1px solid;"><input type="text" value="0" style="border:0" name="inp24" id="totalmasarif"></td>
      </tr>
    </table>
        <br>
        <table style="border: 1px solid;width:70%">
