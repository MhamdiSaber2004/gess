            ...
            <div class="card-header bg-secondary border-0">
              <div class="row align-items-center">
                ...
                <div class="col-6 text-right">
                    <a href="index.php?page=printPremierMa7dherReunionPublique" class="btn btn-sm btn-primary" > محضر جلسة اجتماع مجلس الادارة</a>
...
?>
            ...
            <div class="table-responsive col-12">
              ...
              <table id="listeBenefique" class=" table  align-items-center table-striped table-flush">
                ...
                <tbody>
                <?php
                  $sql = "SELECT * FROM reunioninterne where idGess='$idGess' and `activ`='1'";
                  $result = $conn->query($sql);
                            ...
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        ...
                                        <a class="dropdown-item" href="controller/controller.php?idReunionIDesacive='.$row["idReunI"].'">حذف</a>
                                    </div>
                                </div>
                            </td>
                        </tr>';
