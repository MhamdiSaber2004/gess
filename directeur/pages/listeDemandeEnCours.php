          ...
          <div class="card shadow">
            ...
            <div class="card-header bg-secondary border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">قائمة مطالب الإنخرط</h3></h3>
                </div>

                <div class="col-4 text-right">
                  <a href="index.php?page=listeDemandes" class="btn btn-sm btn-primary">قائمة المنخرطين</a>
            ...
            <div class="table-responsive col-12">
              ...
              <table id="listeBenefique" class=" table  align-items-center table-striped table-flush">
                ...
                <tbody>
                <?php
                                       $sql = "SELECT * FROM demandes where idGess='$idGess' and resultat='قيد التنفيذ'";
                    ...
                    <td>
                    <a class="btn btn-sm btn-primary" data-toggle="modal" data-target="#demande'.$row['idDemande'].'"  href="#" >تفاصيل المطلب</a>
                    </td>
                    ...
                    <div class="card bg-secondary border-0 mb-0">
                      <div class="card-header bg-transparent pb-5">
                          ...
                          <img id="viewFrontCIN" src="../../apbenefique/uploads/'.$row['frontCIN'].'" alt="example placeholder" style="width: 300px;" /> 
                          <img id="viewFrontCIN" src="../../apbenefique/uploads/'.$row['backCIN'].'" alt="example placeholder" style="width: 300px;" /> <br><br>
                          </div>
