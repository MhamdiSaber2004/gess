...
<div class="no-print" id="printDiv">
    ...
    <small class="d-flex justify-content-start text-black">التاريخ <input type="text" style="width: 100px;border: 0;" placeholder="......................"> الساعة<input type="text" style="width: 100px;border: 0;" placeholder="......................">المكان<input type="text" style="width: 100px;border: 0;" placeholder="......................"> اثر الجلسة العامة<input type="text" style="width: 100px;border: 0;" placeholder="......................">المنعقدة  بتاريخ<input type="text" style="width: 100px;border: 0;" placeholder="......................">  &nbsp;<br></small>
    ...
    <small class="d-flex justify-content-start text-black">-السيد <input type="text" style="width: 100px;border: 0;" placeholder="......................">صاحب بطاقة التعريف  رقم : <input type="text" style="width: 100px;border: 0;" placeholder="......................">   &nbsp;<br></small>
    <small class="d-flex justify-content-start text-black">  امين مال للمجمع .  &nbsp;<br></small>
    <small class="d-flex justify-content-start text-black">السيد<input type="text" style="width: 100px;border: 0;" placeholder="......................">   : عضو مكلف بــ : <input type="text" style="width: 100px;border: 0;" placeholder="......................">  &nbsp;<br></small>
    <small class="d-flex justify-content-start text-black">السيد<input type="text" style="width: 100px;border: 0;" placeholder="......................">   : عضو مكلف بــ : <input type="text" style="width: 100px;border: 0;" placeholder="......................">  &nbsp;<br></small>
    <small class="d-flex justify-content-start text-black">السيد<input type="text" style="width: 100px;border: 0;" placeholder="......................">   : عضو مكلف بــ : <input type="text" style="width: 100px;border: 0;" placeholder="......................">  &nbsp;<br></small>
    <small class="d-flex justify-content-start text-black">السيد<input type="text" style="width: 100px;border: 0;" placeholder="......................">   : عضو مكلف بــ : <input type="text" style="width: 100px;border: 0;" placeholder="......................">  &nbsp;<br></small>
    <small class="d-flex justify-content-start text-black">السيد<input type="text" style="width: 100px;border: 0;" placeholder="......................">   : عضو مكلف بــ : <input type="text" style="width: 100px;border: 0;" placeholder="......................">  &nbsp;<br></small>
    ...
    <small class="d-flex justify-content-start text-black<input type="text" style="width: 100px;border: 0;" placeholder="......................">  &nbsp;<br></small>
    ...
    <div class="container text-center text-black">
        <div class="row">
          ...
          <div class="col-3">
          <small > <img src="assets/img/reunion/cacheteGess.png" alt="" style="width:60%;">  &nbsp;</small>

          </div>
          <strong class="col-6"><br><br>
          رئيس الجلسة
          </strong>
        </div>
      </div>
