...
if(isset($_GET['idPayement']) && ! empty ( $_GET['idPayement'] ))
{
    ...
    $sql = "SELECT * FROM archive_payement_aep where idPayement=$idPayement";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($archive_payement_aep = $result->fetch_assoc()) {
            ...
            $sql = "SELECT * FROM benefique_aep where idBenefique=".$archive_payement_aep['idBenefique'];
            $benefiqueRow = $conn->query($sql)->fetch_assoc();


            $sql = "SELECT * FROM pompiste where idPompiste=".$archive_payement_aep['idPompiste'];
            $pompisteRow = $conn->query($sql)->fetch_assoc();


            $sql = "SELECT * FROM gess where idGess=".$archive_payement_aep['idGess'];
  ...
  <div class="main-content">
          ...
          <div class="card-header bg-secondary border-0">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                  <a href="index.php?page=payementAEP" class="btn btn-sm btn-primary">رجوع</a>
                </div>
              </div>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-12 textee" style="text-align: center;">
            عدد : <?php echo $archive_payement_aep['idPayement'] ?>
        </div>
    </div><br><br><br>
    <div class="row">
    ...
    <div class="row">
        <div class="col-12 textee"> توصلت من السيد : <?php echo $benefiqueRow['nom'] ?> ,  بمبلغ : <?php echo $archive_payement_aep['montantPaye'] ?> دت</div>
    </div><br>
    <div class="row">
