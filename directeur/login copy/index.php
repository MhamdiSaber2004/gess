  ...
  <div class="wrapper wrapper--w690">
    ...
    <?php } ?>
            ...
            <div class="tab-content">
              <div class="tab-pane fade <?php  if($_SESSION['login']=="") $class= "active show" ;else $class=""; echo $class ?>" id="pills-login" role="tabpanel" aria-labelledby="tab-login">
                <form>
              ...
              <div class="tab-pane fade <?php  if($_SESSION['login']=="login") $class= "active show" ;else $class=""; echo $class ?>" id="pills-register" role="tabpanel" aria-labelledby="tab-register">
              <form action="index.php" method="post">
                  ...
                  <!-- Submit button -->
                  <button type="submit" name="login" class="btn btn-primary btn-block mb-4" style="font-size : 20px"> الدخول</button>
    <?php echo $error["erreur"] ?>
                  <!-- Register buttons -->
