          ...
          <div class="card shadow">
            ...
            <div class="card-header bg-secondary border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">قائمة حراس النظام المائي</h3>
                </div>
...
$sql = "SELECT * FROM pompiste where idGess=1 and actif=1";
...
?>
            ...
            <div class="table-responsive col-12">
              <table id="listeBenefique" class=" table  align-items-center table-striped table-flush">
                ...
                <tbody>
                <?php
                                       $sql = "SELECT * FROM pompiste where idGess=1";
                                       $result = $conn->query($sql);
                    ...
                    <td class="text-center">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <a class="dropdown-item" href="index.php?page=printPompiste&id='.$row['id'].'">تفاصيل و طباعة</a>
                          <a class="dropdown-item" href="index.php?page=modifPompiste&id='.$row["id"].'">تحيين</a>
