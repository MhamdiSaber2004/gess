          ...
          <div class="card shadow">
            ...
            <div class="card-header bg-secondary border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">قائمة مطالب الانتفاع بالماء </h3>
                </div>
                <div class="col-4 text-right">
                  <a href="index.php?page=demande" class="btn btn-sm btn-primary">مطلب انتفاع جديد</a>
                </div>
              </div>
            </div>
...
<table id="listeBenefique" class=" table  align-items-center table-striped table-flush">
                <thead class="thead-light">
                  <tr>
                  <th scope="col">رمز مطلب الانتفاع</th>
