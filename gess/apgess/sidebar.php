...
أعوان التنفيذ            </a>
          ...
          <li class="nav-item <?php echo ($current_page === 'listePompiste') ? 'active' : ''; ?>">
            <a class="nav-link" href="index.php?page=listeDirecteurs">
              <i class="ni ni-circle-08 text-blue"></i> المدير الفني  
            </a>
          </li>
          <li class="nav-item <?php echo ($current_page === 'prgPompeEauQuotiqien') ? 'active' : ''; ?>">
            ...
            <i class="ni ni-chart-bar-32 text-blue"></i>برنامج التوزيع اليومي
            </a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#" data-toggle="modal" data-target="#stationPompe">
              <i class="ni ni-chart-bar-32 text-red"></i>استغلال محطة الضخ 
            </a>
          </li>
...
<hr class="my-3">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?page=rapportFinancier">
              <i class="ni ni-bullet-list-67 text-red"></i>  التقرير المالي
            </a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="index.php?page=rapportLitteraire">
