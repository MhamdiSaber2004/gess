...
function calcul(){
     ...
     if (quantite_prevue_achat_ou_pompage != 0){
         document.getElementById("heure_travail_ness").value=(debit_pompe/quantite_prevue_achat_ou_pompage).toFixed(0)
     }
    
     document.getElementById("quantite_prevue_distribution").value=(  (document.getElementById("quantite_prevue_achat_ou_pompage").value*document.getElementById("pourcentage_perte").value)-document.getElementById("quantite_prevue_achat_ou_pompage").value).toFixed(2);
    ...
    document.getElementById("revenues_des_frais_globaux").value = (document.getElementById("surface_totale").value*document.getElementById("montant_mensuel_net").value*12).toFixed(3);
