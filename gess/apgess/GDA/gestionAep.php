...
<table>
    ...
    <tr>
      <td colspan="1" ><?php echo $row["liaison_prive"] ;?></td>
      <td colspan="2" >عدد الربط الخاص</td>
      <td colspan="2" ><?php echo $row["surface_totale"] ;?> </td>
      <td colspan="2" > عدد العائلات المنتفعة </td>
      <td colspan="1"  style="width:8px">(1)</td>
    </tr>
    <tr>
      <td colspan="1" ><?php echo $row["nombre_points_deau_publics"] ;?></td>
      <td colspan="2" >عدد  الحنفيات العمومية ومزودي الصهاريج</td>
      <td colspan="2" > </td>
      <td colspan="2" > </td>
    ...
    <tr>
      <td  colspan="1"><?php echo $row["connexion_dediee"] ;?></td>
      <td  colspan="1">	م3</td>
      <td  colspan="3">عبر الربط الخاص	</td>
      <td  colspan="2" rowspan="2">   الكمية المزمع توزيعها</td>
      <td  colspan="1" style="width:8px">(6)</td>
    </tr>
    <tr>
      <td  colspan="1"><?php echo $row["points_deau_publics"] ;?></td>
      <td  colspan="1">	م3</td>
      <td  colspan="3"> عبر الحنفيات العمومية/ مزود الصهاريج </td>
      <td  colspan="1" style="width:8px">(7)</td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="1" style="width: 150px"><?php echo $row["nombre_membres"] ;?></td>
    ...
    <tr>
      <td colspan="1" ><?php echo $row["nombre_bi_prevus"] ;?></td>
      <td colspan="2" >المزمع انجازها BI عدد</td>
      <td colspan="1" >(33)</td>
      <td colspan="1" ><?php echo $row["prix_litre_javal"] ;?></td>
      <td colspan="2" >  	سعر لتر جافال    </td>
      <td colspan="1"  style="width:8px">(23)</td>
    </tr>
    <tr>
      <td colspan="1" ><?php echo $row["bi_realisation"] ;?></td>
      <td colspan="2" > BI معلوم إنجاز </td>
      <td colspan="1" >(34)</td>
    ...
    <tr>
      <td colspan="1" ><?php echo $row["couverture_deficit_maintenance"] ;?></td>
      <td colspan="2" >تغطية عجز الصيانة</td>
      <td colspan="1" >(36)</td>
    ...
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><?php echo $row["remuneration_gardien_gestionnaire"] ;?></td>
      <td colspan="2" >	أجرة الحارس المتصرف = (7) * (30)	</td>
    </tr> 
    <tr>
      <td colspan="1" >د</td>
    ...
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><?php echo $row["depenses_analyse_eau"] ;?></td>
      <td colspan="2" >	مصاريف تحليل الماء</td>
      <td colspan="1"  style="width:8px">(45)</td>
    </tr> 
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><?php echo $row["depenses_jafal"] ;?></td>
      <td colspan="2" >	مصاريف الجافال</td>
      <td colspan="1"  style="width:8px">(46)</td>
    </tr> 
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><?php echo $row["huiles_et_filtres"] ;?></td>
      <td colspan="2" >زيوت و مصافي</td>
    ...
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><?php echo $row["cout_realisation_connexion_speciale"] ;?></td>
      <td colspan="2" >تكاليف انجاز الربط الخاص = (33) * (34)</td>
    ...
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><?php echo $row["cout_realisation_connexion_speciale"] ;?></td>
      <td colspan="5" >المداخيل الموظفة على انجاز الربط الخاص = (33) * (34)</td>
    ...
    <tr>
      ...
      <td colspan="3" >	سعر م3 باعتبار حارس متصرف = (58) / (5)</td>
      <td colspan="2" rowspan="2">	على مستوى الحنفيات العمومية / مزود الصهاريج</td>
      <td colspan="1"  style="width:8px">(64)</td>
    </tr> 
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><?php echo $row["prix_m3_sans_garde_administrateur"] ;?></td>
      <td colspan="3" >	سعر م3 من الماء بدون حارس متصرف = ((58) - (أجرة الحارس المتصرف)) / (5)	</td>
      <td colspan="1"  style="width:8px">(65)</td>
    </tr> 
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><?php echo $row["tarif_m3_eau"] ;?></td>
      <td colspan="3" >	سعر م3  = (58) / (5)</td>
      <td colspan="2" rowspan="2">	على مستوى الربط الخاص</td>
      <td colspan="1"  style="width:8px">(66)</td>
    </tr> 
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><?php echo $row["information_mensuelle_global"] ;?></td>
      <td colspan="3" >		المعلوم الشهري القار = ( 35 )</td>
      <td colspan="1"  style="width:8px">(67)</td>
    </tr> 
...
<?php }}else { ?>
  <div style="display:flex;">
<button class="capture-button" onclick="location.href='ajougda.html'">رجوع</button>
</div>
<h3 style="text-align: right;font-size:22px">مرحبا, حسام </h3>
<h5 style="text-align: right;font-size:16px"> مجمع التنمية في قطاع الفلاحة و الصيد البحري للماء الصالح للشرب</h5><br>
...
<table>
    ...
    <?php
      $sql = "SELECT * 
      FROM
      distribution_eau where idGess=$idGess";
      ...
      if ($result) {
          ...
          $liaison_prive = $row['liaison_prive'];
          $nombre_points_deau_publics=$row['fournisseurs_reservoirs']+$row['robinet_public'];
      } 

  ?>
    <tr>
      <td colspan="1" ><input type="number" step="any" name="liaison_prive" id="liaison_prive" dir="rtl" placeholder=" عدد الربط الخاص" value="<?php echo $liaison_prive; ?>"  ></td>
      <td colspan="2" >عدد الربط الخاص</td>
      <td colspan="2" ><input type="number" step="any" name="surface_totale" id="surface_totale" dir="rtl" placeholder=" عدد العائلات المنتفعة"  > </td>
      <td colspan="2" > عدد العائلات المنتفعة </td>
      <td colspan="1"  style="width:8px">(1)</td>
    </tr>
    <tr>
      <td colspan="1" ><input type="number" step="any" name="nombre_points_deau_publics" id="nombre_points_deau_publics" dir="rtl" value="<?php echo $nombre_points_deau_publics ?>" placeholder="عدد الحنفيات العمومية ومزودي الصهاريج"   ></td>
      <td colspan="2" >عدد  الحنفيات العمومية ومزودي الصهاريج</td>
      <td colspan="2" > </td>
      <td colspan="2" > </td>
      <td colspan="1"  style="width:8px">(2)</td>
    ...
    <tr>
      <td  colspan="1"><input type="number" step="any"   name="connexion_dediee" id="connexion_dediee" placeholder="عبر الربط الخاص	" dir="rtl"  value="" onchange="calcul()"  ></td>
      <td  colspan="1">	م3</td>
      <td  colspan="3">عبر الربط الخاص	</td>
      <td  colspan="2" rowspan="2">   الكمية المزمع توزيعها</td>
      <td  colspan="1" style="width:8px">(6)</td>
    ...
    <tr>
      <td  colspan="1"><input type="number" step="any" name="points_deau_publics" placeholder="عبر الحنفيات العمومية" id="points_deau_publics"  dir="rtl"  value="" onchange="calcul()"  ></td>
      <td  colspan="1">	م3</td>
      <td  colspan="3"> عبر الحنفيات العمومية/ مزود الصهاريج </td>
      <td  colspan="1" style="width:8px">(7)</td>
    </tr>
    ...
    <tr>
      <td colspan="1" ><input type="number" step="any" onchange="calcul()" dir="rtl" name="nombre_bi_prevus" id="nombre_bi_prevus" placeholder="  BI عدد"  ></td>
      <td colspan="2" >  المزمع انجازها BI    عدد </td>
      <td colspan="1" >(33)</td>
      <td colspan="1" ><input type="number" step="any" onchange="calcul()" dir="rtl" name="prix_litre_javal" id="prix_litre_javal" placeholder="سعر لتر جافال"  ></td>
      <td colspan="2" >  	سعر لتر جافال    </td>
      <td colspan="1"  style="width:8px">(23)</td>
    </tr>
    <tr>
      <td colspan="1" ><input type="number" step="any" onchange="calcul()" dir="rtl" name="bi_realisation" id="bi_realisation" placeholder="BI معلوم إنجاز "  ></td>
      <td colspan="2" >BI معلوم إنجاز </td>
      <td colspan="1" >(34)</td>
    ...
    <tr>
      <td colspan="1" ><input type="number" step="any" onchange="calcul()" dir="rtl" name="couverture_deficit_maintenance" id="couverture_deficit_maintenance" placeholder=" تغطية عجز الصيانة"  ></td>
      <td colspan="2" >تغطية عجز الصيانة</td>
      <td colspan="1" >(36)</td>
    ...
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input disabled type="number" step="any" onchange="calcul()" dir="rtl" name="remuneration_gardien_gestionnaire" id="remuneration_gardien_gestionnaire"  onchange="calcul()" ></td>
      <td colspan="2" >أجرة الحارس المتصرف = (7) * (30)	</td>
    </tr> 
    <tr>
      <td colspan="1" >د</td>
    ...
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input type="number" step="any" onchange="calcul()" dir="rtl" name="depenses_analyse_eau" id="depenses_analyse_eau" placeholder=" مصاريف تحليل الماء" onchange="calcul()" ></td>
      <td colspan="2" >	مصاريف تحليل الماء</td>
      <td colspan="1"  style="width:8px">(45)</td>
    </tr> 
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input disabled type="number" step="any" onchange="calcul()" dir="rtl" name="depenses_jafal" id="depenses_jafal"  onchange="calcul()" ></td></td>
      <td colspan="2" > 	مصاريف الجافال  = ((3)/(40))*23</td>
      <td colspan="1"  style="width:8px">(46)</td>
    </tr> 
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input  type="number" step="any" dir="rtl" name="huiles_et_filtres" placeholder="زيوت و مصافي" id="huiles_et_filtres" onchange="calcul()" ></td>
      <td colspan="2" >زيوت و مصافي</td>
      <td colspan="1"  style="width:8px">(47)</td>
    </tr> 
    <tr>
    ...
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input disabled type="number" step="any" dir="rtl" name="cout_realisation_connexion_speciale" id="cout_realisation_connexion_speciale" onchange="calcul()"></td>
      <td colspan="2" >تكاليف انجاز الربط الخاص = (33) * (34)</td>
      <td colspan="3"rowspan="2" >  			مصاريف الإستثمار والتجهيز  </td>
      <td colspan="1" rowspan="2" style="width:8px">(53)</td>
    </tr> 
    ...
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input disabled type="number" step="any" dir="rtl" name="revenus_realises_sur_realisation_raccordement_specifique" id="revenus_realises_sur_realisation_raccordement_specifique" onchange="calcul()" ></td>
      <td colspan="5" >المداخيل الموظفة على انجاز الربط الخاص = (33) * (34)</td>
      <td colspan="1"  style="width:8px">(60)</td>
    </tr> 
    <tr>
    ...
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input disabled type="number" step="any" dir="rtl" name="prix_m3_sans_garde_administrateur" id="prix_m3_sans_garde_administrateur" onchange="calcul()" ></td>
      <td colspan="3" >	سعر م3 من الماء بدون حارس متصرف = ((58) - (أجرة الحارس المتصرف)) / (5)	</td>
      <td colspan="1"  style="width:8px">(65)</td>
    </tr> 
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input disabled type="number" step="any" dir="rtl" name="tarif_m3_eau" id="tarif_m3_eau1" onchange="calcul()" ></td>
      <td colspan="3" >	سعر م3  = (58) / (5)</td>
      <td colspan="2" rowspan="2">	على مستوى الربط الخاص</td>
      <td colspan="1"  style="width:8px">(66)</td>
    </tr> 
    <tr>
      <td colspan="1" >د</td>
      <td colspan="1" ><input disabled type="number" step="any" dir="rtl" name="information_mensuelle_global" id="information_mensuelle_global" onchange="calcul()" ></td>
      <td colspan="3" >		المعلوم الشهري القار = ( 35 )</td>
      <td colspan="1"  style="width:8px">(67)</td>
    </tr> 
    
    <th colspan="8" style="text-align: center;background-color: white;">  <button class="btn btn-success btnsub" type="submit" name="submit1">تسجيل</button>  </th>
