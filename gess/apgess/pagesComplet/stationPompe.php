  ...
  <body>
              ...
              <div class="row align-items-center">
                <div class="col-6 text-center">
                  <h3 class=""><button onclick="printPompiste('printDiv')" class="btn btn-sm btn-primary">طباعة</button> </h3>
                </div>
                <div class="col-6 text-center">
...
<br><br>
  ...
  <tr>
   <td rowspan="3">التاريخ</td>
   <td colspan="3">مدة الضخ		</td>
   <td rowspan="3">رقم العداد المائي</td>
   <td colspan="4">الطاقة الكهربائية			</td>
   <td colspan="3">&nbsp;</td>
   <td colspan="5">&nbsp;</td>
   <td rowspan="3">ملاخظات </td>
  </tr>
  ...
  <td rowspan="2">من</td>
  <td rowspan="2">الى</td>
  <td rowspan="2">العداد الساعاتي</td>

   <td rowspan="2">عداد النهار</td>
   <td rowspan="2">عداد الليل </td>
   <td rowspan="2">عداد المساء</td>
   <td rowspan="2">عداد الذروة</td>
   <td rowspan="2" class="rotate-arabic">شراء</td>
   <td rowspan="2" class="rotate-arabic">مستعمل</td>
   <td rowspan="2" class="rotate-arabic">اشتغال المضخة</td>
   <td rowspan="2" class="rotate-arabic">انقطاع الماء</td>
   <td rowspan="2" class="rotate-arabic">عطب محطة الضخ</td>
   <td rowspan="2" class="rotate-arabic">انقطاع الطاقة</td>
   <td colspan="2">عطب في الشبكة	</td>
  </tr>
  

<tr>
   <td class="rotate-arabic">كلي</td>
   <td class="rotate-arabic">جزئي</td>
</tr>
