  ...
  <div class="card-header bg-transparent pb-5">
      ...
      <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="number" name="numConsomme" id="numConsomme" class="form-control form-control-alternative" placeholder="إستهلاك العداد بعد عملية البيع" >
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="number" name="prix" id="prix" class="form-control form-control-alternative" placeholder="السعر" >
                    ...
                    <div class="col-lg-12">
                     ...
                     <input type="file" id="file1" class="form-control "  name="file1" accept="image/*">
                     </div>
                   </div>
 ...
 <?php echo $_SESSION['message'];  unset($_SESSION['message']); ?>
  ...
  <div class="card-header bg-transparent pb-5">
      ...
      <div class="btn-wrapper text-center">
                     ...
                     <img id="id" src="../../appompiste/uploads/<?php echo $row['facture'] ?>" alt="example placeholder" style="width: 300px;" /> 
                     </div>
