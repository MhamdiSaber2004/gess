...
<div class="no-print" id="printDiv">
    ...
    <small class="d-flex d-xxl-flex justify-content-start justify-content-xxl-start text-black" >&nbsp; المعتمدية : <?php echo $etat['accreditation'] ?>&nbsp;</small>
    <small class="d-flex d-xxl-flex justify-content-start justify-content-xxl-start text-black" >&nbsp; الولاية : <?php echo $etat['nom_etat'] ?>&nbsp;</small>
    ...
    <small class="d-flex d-xxl-flex justify-content-start justify-content-xxl-start text-black" >&nbsp;<br><span style="color: rgb(0, 0, 0); background-color: rgb(253, 253, 253);">صاحب بطاقات التعريف الوطنية عدد : &nbsp;<strong><?php if(strlen($row['CIN'])<8) echo '0'.$row['CIN']; else echo $row['CIN'];  ?></strong>&nbsp;</span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;<br><span style="color: rgb(0, 0, 0); background-color: rgb(253, 253, 253);">مسلمة في : &nbsp;<strong><?php echo $row['dateCIN'];  ?></strong></span><br></small>
    <small class="d-flex d-xxl-flex justify-content-start justify-content-xxl-start text-black" >&nbsp;<br><span style="color: rgb(0, 0, 0); background-color: rgb(253, 253, 253);">الحالة العائلية : &nbsp;<strong><?php echo $row['famille'];  ?></strong></span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<span style="color: rgb(0, 0, 0); background-color: rgb(253, 253, 253);">المهنة : &nbsp;<strong><?php  $row['travail'];  ?></strong></span></small>
