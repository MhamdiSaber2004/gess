          ...
          <div class="card shadow">
            ...
            <div class="card-header bg-secondary border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">المدير الفني</h3>
                </div>

                <div class="col-4 text-right">
                  <a href="index.php?page=ajoutPompiste" class="btn btn-sm btn-primary">إضافة مدير فني</a>
                </div>
              </div>
            </div>
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              ...
              <table id="listeBenefique" class=" table  align-items-center table-striped table-flush">
                <thead class="thead-light">
                  <tr>
                    <th scope="col">رمز المدير الفني</th>
                ...
                <tbody>
                <?php
                                       $sql = "SELECT * FROM pompiste where idGess='$idGess' and actif=1 and directeur=1";
                                       $result = $conn->query($sql);
