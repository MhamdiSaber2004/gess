...
if (isset($_POST["connexion"])) {
    ...
    $sql = "SELECT * FROM utilisateurs inner join gess on utilisateurs.idGess=gess.idGess where email_utilisateur='$username' and mdp='$password'";
    ...
    if ($result->num_rows > 0) {
        ...
        if ($row["etat"] == 1) {
            ...
            $idGessCookies=$row["idGess"]+3333;
            
            $_SESSION["idGess"] = $row["idGess"];
            $_SESSION['my_variable'] = 'Hello from File 1!';
