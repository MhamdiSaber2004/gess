            ...
            <div class="card-header bg-secondary border-0">
              <div class="row align-items-center">
                ...
                <div class="col-4 text-right">
                  <a href="#" class="btn btn-sm btn-primary"  data-toggle="modal" data-target="#ajoutDocument">إضافة </a>
                </div>
              </div>
            </div>
                    ...
                    <td class="text-center">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          ...
                          <!--<a class="dropdown-item"  href="controller/controller.php?idPompisteSupprimer='.$row['idD'].'">حذف</a>-->
                        </div>
                      </div>
                    </td>
                    </tr>
