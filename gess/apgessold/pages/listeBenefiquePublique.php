          ...
          <div class="card shadow">
            ...
            <div class="card-header bg-secondary border-0">
              <div class="row align-items-center">
                ...
                <a href="index.php?page=ajoutBenefiquePublique" class="btn btn-sm btn-primary">إضافة منتفع</a>
 ...
 <?php echo $_SESSION['message'];  unset($_SESSION['message']); ?>
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            ...
            <table id="listeBenefique" class=" table  align-items-center table-striped table-flush">
                ...
                <tbody>
                <?php
                                       $sql = "SELECT * FROM benefique_publique where idGess='$idGess' ";
                    ...
                    <td class="text-center">
                      <div class="dropdown">
                        ...
                        <a class="dropdown-item" href="controller/controller.php?idBenefiquePubliqueSupprimer='.$row["idBenefique"].'">حذف</a>
                        </div>
                      </div>
                    </td>
                    </tr>
