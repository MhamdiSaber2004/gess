          ...
          <div class="card shadow">
            ...
            <div class="card-header bg-secondary border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">قائمة المنتفعين (حسابات معطلة)</h3>
                </div>
  ...
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            ...
            <table id="listeBenefique" class=" table  align-items-center table-striped table-flush">
                ...
                <?php
                    ...
                    <a href="controller/controller.php?accepteBenefiquePI='.$row["idBenefique"].'" class="btn btn-sm btn-primary"> إعادة تشغيل الحساب   </a>
