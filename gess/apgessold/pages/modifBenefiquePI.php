            ...
            <div class="card-body">
              ...
              <h6 class="heading-small text-muted mb-4">معلومات المنتفع </h6>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <input type="number" name="numPrise" id="numPrise" list="numPrises" class="form-control form-control-alternative" placeholder="رقم المأخذ " value="<?php echo $row['numPrise'];  ?>">
                ...
                <div class="text-center">
                  <button type="submit" name="modifBenefiquePI" class="btn btn-primary my-4">تحيين</button>
                </div>
              </form>
            </div>
          </div>
