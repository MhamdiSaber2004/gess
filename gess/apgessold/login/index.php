...
<html lang="en">
  ...
  <div class="wrapper wrapper--w690">
      ...
      <div class=" rounded-5" >
        ...
        <section class="w-100 p-4 d-flex justify-content-center pb-4">
          <div class="first-div" >
                ...
                {
                  echo '<div class="alert alert-danger" id="inscri" style="text-align:center;display:block;">  
                  <span style="text-align:center;color : green;font-size:18px;"> '.$_SESSION['message'].'
                 </span>
                 </div>';
    ...
    <?php } if(isset($error["erreur"])) {?>
    <div class="alert alert-warning" id="inscri" style="text-align:center;display:block;">  
           <span style="text-align:center;color : blue;font-size:18px;">  <?php echo $error["erreur"] ?>
          </span>
          </div>
          <?php } ?>
            <!-- Pills navs -->
            ...
            <div class="tab-content">
              ...
              <form action="../controller/controller.php" method="post">
                  ...
                  <div class="form-outline mb-4">
                    <input type="email" name="email" id="loginName" class="form-control"  style="margin-top : 30px;"  value="aaaa@aaaa.com">
                  ...
                  <!-- Password input -->
                  <div class="form-outline mb-4">
                    <input type="password" name="password" id="loginPassword" class="form-control" value="aaaa@aaaa.com">
                  ...
                  <!-- Submit button -->
                  <button type="submit" name="connexion" class="btn btn-primary btn-block mb-4" style="font-size : 20px"> الدخول</button>
                  <!-- Register buttons -->
